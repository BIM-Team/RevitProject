...
//            Dictionary<string, float> Data_CX = mysql.SelectOneCXData("CX1");
//            OutputCXdata(Data_CX);

//            string cx = "CX1";
//            DateTime dt = Convert.ToDateTime("2015/7/17下午");
//            Dictionary<string, float> Data_OneCX = mysql.SelectOneDateData(cx, dt);
...
//        //获取数据库数据
//        public static void OutputCXdata(Dictionary<string, float> Data_CX)
//        {
//            System.Console.WriteLine("输出查询的CX信息");
//            StringBuilder str = new StringBuilder();

//            str.Append("实体信息: ").Append("\n");
//            foreach (string d in Data_CX.Keys)
//            {
//                str.Append(d).Append(" ").Append(Data_CX[d]).Append(" ").Append("\n");
//            }
...
//            System.Console.ReadKey();
//        }
//        public static void OutputOneCXdata(Dictionary<string, float> Data_CX)
//        {
//            System.Console.WriteLine("输出查询的CX信息");
//            StringBuilder str = new StringBuilder();

//            str.Append("不同深度的信息: ").Append("\n");
//            foreach (string d in Data_CX.Keys)
//            {
//                str.Append(d).Append(" ").Append(Data_CX[d]).Append(" ").Append("\n");
//            }
